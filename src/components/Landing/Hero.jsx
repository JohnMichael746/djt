      ...
      <div className="max-w-6xl px-4 mx-auto">
        <div className="flex flex-col items-center pt-32 max-md:flex-col-reverse md:flex-row sm:pt-40 md:pb-10 lg:pb-0">
          <div className="w-[90%] sm:w-[75%] md:w-[55%] md:-mt-11">
            <h1 className="font-coiny text-[#93fcec] text-[35px] font-medium text-center">WELCOME TO</h1>
            ...
            <div className="relative z-10 flex flex-col items-center justify-center mt-4 space-y-4 lg:flex-row lg:space-y-0 lg:space-x-4">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="leading-none text-[#bcbabc] hover:text-teal-500 font-coiny rounded-full font-normal text-center flex items-center space-x-2.5 justify-center w-64 py-5 text-base uppercase"
              >
